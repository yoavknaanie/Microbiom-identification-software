...
running parameters:
	...
	raw_file_list: list of names of raw files you want to run. Notice that each raw file should contain only the file
	names without path and without .raw postfix.
